        ...
        <div className="mt-12 bg-gray-800 rounded-xl p-6 shadow-lg max-w-4xl">
          ...
          {character && (
            <div className="bg-gray-900 p-6 rounded-lg space-y-4">
              <p>
                <span className="font-bold text-yellow-400">Nome:</span>{" "}
                {character.name}
              </p>
              <p>
                <span className="font-bold text-yellow-400">Classe:</span>{" "}
                {character.class}
              </p>
              <p>
                <span className="font-bold text-yellow-400">Razza:</span>{" "}
                {character.race}
              </p>
              ...
              <div>
                <p className="font-bold text-yellow-400 mb-1 mt-4">
                  Inventario:
                </p>
                {character.inventory.length > 0 ? (
                  ...
                  <p className="text-sm text-gray-400">
                    Nessun oggetto. Trova oggetti durante le partite!
                  </p>
                )}
              </div>
            ...
            <div className="bg-gray-900 p-6 rounded-xl max-w-md w-full text-white space-y-4 shadow-2xl">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  Punti rimanenti: {remainingPoints}
                </p>
              </div>
